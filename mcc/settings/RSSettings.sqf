if (count (allMissionObjects "MCC_Module_settingsRS") == 0) then {
    ...
    [
        "CP_activated",
        "CHECKBOX",
        ["Вкл Выбор Ролей","Enable role selection menu allows player to gain XP and unlock new weapons and items"],
        "MCC Role Selection",
        false,
        true
    ...
    [
        "MCC_rsAllWeapons",
        "CHECKBOX",
        ["Разблокировать все оружие","Unlock All Weapons ignoting the player level"],
        "MCC Role Selection",
        false,
        true
    ] call CBA_Settings_fnc_init;
    ...
    [
        ...
        "CHECKBOX",
        ["Смена Роли","Players can change roles in HQ"],
        "MCC Role Selection",
        true,
        true
    ] call CBA_Settings_fnc_init;
    ...
    [
        ...
        "CHECKBOX",
        ["Ограничить Оружие","Players using weapons outside of their role (eg rifleman using sniper rifle) will get penalty by increased weapon sway"],
        "MCC Role Selection",
        false,
        true
    ] call CBA_Settings_fnc_init;
    ...
    [
        ...
        "CHECKBOX",
        ["Ограничить Транспорт","Players can't use vehicles outside of their role (eg rifleman driving a tank) except light vehicles"],
        "MCC Role Selection",
        false,
        true
    ] call CBA_Settings_fnc_init;
    ...
    [
        "CP_defaultGroups",
        "EDITBOX",
        ["Позывные","Default groups callsigns"],
        "MCC Role Selection",
    ...
    */
    ...
    [
        "CP_expNotifications",
        "CHECKBOX",
        ["Получение уведомления об XP","Players will get notifications when gaining XP"],
        ["MCC Role Selection","Experiance Points"],
        true,
        true
    ] call CBA_Settings_fnc_init;
    ...
    [
        "CP_XPperLevel",
        "SLIDER",
        ["Базовое XP","Base Xp needed for each level, Exp will raise by 5% each level"],
        ["MCC Role Selection","Experiance Points"],
        [1000, 10000, 4000, 0],
        true
    ] call CBA_Settings_fnc_init;
