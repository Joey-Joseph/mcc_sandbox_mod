...
_str = "<t size='0.8' t font = 'puristaLight' color='#FFFFFF'>" + "Удерживайте Shift чтобы выключить MCC" + "</t>";
...
_ctrlButtonCustom ctrlsetText "Добавить";
...
if (_cargEnabled) then
{
	...
	_ctrlButtonCustom2 ctrlsetText "Груз";
...
if (_loadOutEnabled) then
{
	...
	_ctrlButtonCustom3 ctrlsetText "Арсенал";
