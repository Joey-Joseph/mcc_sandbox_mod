...
if (missionNamespace getvariable ["MCC_showActionKey",true]) then {
	...
	_null = player addaction ["<img size='1.5' image='\A3\Ui_f\data\GUI\Cfg\Ranks\colonel_gs.paa'/>""<t color=""#FFCC01"">КОМЛОГ</t>", MCC_path + "mcc\dialogs\mcc_PopupMenu.sqf",[nil,nil,nil,nil,1],-1,false,true,"",_string];
