...
{
	displayName = "Ammo Container (MCC)";
	maximumLoad = 600*4;
...
{
	displayName = "Supply Container (MCC)";
	maximumLoad = 600*4;
	transportAmmo = 0;
...
{
	displayName = "Fuel Container (MCC)";
	maximumLoad = 600*4;
	transportAmmo = 0;
	transportFuel = 500*4;
	author = "MCC-Team";
