...
_factionArray = [];
{
 ...
 _resualt = ["Динамические гражданские - запускается на сервере (загружает CPU)",[
 						["Динамические гражданские",true],
 						["Динамические Машины",true],
 						["Динамические Припаркованные Машины",true],
 						["Припаркованные Машины всегда будут закрыты",false],
 						["Дистанция появления от игрока",500],
 						["Максимум юнитов",8],
 						["Фракция",_factionArray],
 						["Фракция Машин",_factionArray],
 						["Реакция гражданских на игрока",["Плохая (СВУ & Моджахеды)","Средняя","Хорошая","Отличная"]],
 						["Гражданские всегда дружелюбны ",false]
