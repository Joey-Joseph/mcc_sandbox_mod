...
_resualt = ["Создать точку захвата",[["Type",[["Ammo",format ["%1data\IconAmmo.paa",MCC_path]],["Supply",format ["%1data\IconRepair.paa",MCC_path]],["Fuel",format ["%1data\IconFuel.paa",MCC_path]],["Tickets",""]]],
				["Радиус",300],
				["Количество очков",1000],
				["Флаг",false],
				["UI",true]
