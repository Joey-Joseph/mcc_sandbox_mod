...
//Suicide Bomber
if (_object isKindOf "Man") then {
	_resualt = ["Сделать юнита Моджахедом",[
	 						["Размер взрыва",["Маленький","Средний","Большой"]],
	 						["Эффект взрыва",["Убивает","Отключает","Фейк","Нет"]],
	 						["Сторона активации",["Красные","Синие","Зеленые"]]
