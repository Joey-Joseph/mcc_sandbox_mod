...
_factionArray = [];
{
 ...
 _resualt = ["Создает Компанию - Требуется: Стартовая локация",[
 						["Фракция игроков",_factionArray],
 						["Фракция врагов",_factionArray],
 						["Фракция гражданских",_factionArray],
 						["Миссий до конца компании",100],
 						["Сложность",["Легкая","Средняя","Сложная"]],
 						["Соперники игроков",["Красные","Синии","Зеленые","Нет"]],
 						["Тикеты",1000],
 						["Ротации Миссии",10],
 						["Размер миссии",1000],
 						["Загружать из базы",false],
 						["Интро",["Кинематографичное","Простое","Нет"]]
