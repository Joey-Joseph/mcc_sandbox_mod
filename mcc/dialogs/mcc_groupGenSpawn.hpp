...
class MCC_spawnDialogControls:MCC_RscControlsGroup
{
	...
	class Controls
	{
		...
		class mcc_groupGen_classAddButton: MCC_RscButton
		{
			...
			text = "В список"; //--- ToDo: Localize;
			x = 0.183334 * safezoneW;
			y = 0.0549786 * safezoneH;
			w = 0.065625 * safezoneW;
			h = 0.035 * safezoneH;
			tooltip = "Добавить выбранных юнитов в список"; //--- ToDo: Localize;
		};
		class mcc_groupGen_groupListBoxClearButton: MCC_RscButton
		{
			...
			text = "Отчистить"; //--- ToDo: Localize;
			x = 0.183334 * safezoneW;
			y = 0.098962 * safezoneH;
			w = 0.065625 * safezoneW;
			h = 0.035 * safezoneH;
			tooltip = "Удалить все из списка"; //--- ToDo: Localize;
		};
		class mcc_groupGen_groupListSaveButton: MCC_RscButton
		{
			...
			text = "Сохранить"; //--- ToDo: Localize;
			x = 0.292188 * safezoneW;
			y = 0.208919 * safezoneH;
			w = 0.065625 * safezoneW;
			h = 0.035 * safezoneH;
			tooltip = "Сохранить группу"; //--- ToDo: Localize;
			sizeEx = "(((((safezoneW / safezoneH) min 1.2) / 1.2) / 25) * 0.8)";
		};
		class mcc_groupGen_groupListBoxCreaterButton: MCC_RscButton
		{
			...
			w = 0.065625 * safezoneW;
			h = 0.035 * safezoneH;
			tooltip = "Нажмите ЛКМ на карте чтобы создать юнита/группу - Удерживайте CTRL чтобы создать несколько"; //--- ToDo: Localize;
		};
		class mcc_groupGen_groupListBoxAddToZoneButton: MCC_RscButton
		{
			...
			text = "Создать в зоне"; //--- ToDo: Localize;
			x = 0.183334 * safezoneW;
			y = 0.208919 * safezoneH;
			w = 0.065625 * safezoneW;
			h = 0.035 * safezoneH;
			tooltip = "Создает группу в выбранной зоне"; //--- ToDo: Localize;
		};
		class MCC_zoneLocTittle: MCC_RscText
		{
			idc = -1;

			text = "Местоположение:"; //--- ToDo: Localize;
			x = 0.00572967 * safezoneW;
		...
		{
			idc = 3022;
			tooltip = "Юниты не буду спавнится пока игрок далеко";
			x = 0.05 * safezoneW;
			y = 0.26 * safezoneH;
		...
		{
			idc = 3023;
			tooltip = "Юнины заспавнятся и автоматически закэшируются";
			x = 0.13 * safezoneW;
			y = 0.26 * safezoneH;
			w = 0.0171875 * safezoneW;
			h = 0.022 * safezoneH;
