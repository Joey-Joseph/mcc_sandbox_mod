...
class MCC_GroupGenInfo:MCC_RscControlsGroup
{
	...
	class Controls
	{
		...
		class MCC_GroupGenInfo_gaiaBehaviorButton: MCC_RscButton
		{
			...
			h = 0.0219914 * safezoneH;
			tooltip = "Отдает группу ИИ GAIA в выбранную зону с выбранным поведением"; //--- ToDo: Localize;
		...
		class MCC_GroupGenInfo_gaiaRespawnComboButton: MCC_RscButton
		{
			...
			text = "Возрожения"; //--- ToDo: Localize;

			w = 0.06 * safezoneW;
			h = 0.0219914 * safezoneH;
			tooltip = "Группа будет возрождаться пока счетчик не будет равен 0"; //--- ToDo: Localize;
			sizeEx = "(((((safezoneW / safezoneH) min 1.2) / 1.2) / 25) * 0.7)";
		};
		...
		class  MCC_GroupGenInfo_giveToPlayer: MCC_RscButton
		{
			...
			w = 0.0572917 * safezoneW;
			h = 0.0219914 * safezoneH;
			tooltip = "Отдает управление группой в КОМЛОГ"; //--- ToDo: Localize;
			sizeEx = "(((((safezoneW / safezoneH) min 1.2) / 1.2) / 25) * 0.7)";
		};
		...
		class MCC_GroupGenInfo_cacheButton: MCC_RscButton
		{
			...
			tooltip = "Кэширует данную группу";
