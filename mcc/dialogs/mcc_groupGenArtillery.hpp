class MCC_artilleryDialogControls:MCC_RscControlsGroup
{
	...
	class Controls
	{
		...
		class MCC_artilleryNumberTitle: MCC_RscText
		{
			...
			text = "Кол. Выстрелов:"; //--- ToDo: Localize;
		...
		class MCC_artilleryCall: MCC_RscButton
		{
			...
			h = 0.0329871 * safezoneH;
			tooltip = "Вызавет артиллерию ЛКМ по карте. Если удерживать Ctrl можно вызвать несколько"; //--- ToDo: Localize;
		};
		class MCC_artilleryAdd: MCC_RscButton
		{
			...
			w = 0.0859375 * safezoneW;
			h = 0.0329871 * safezoneH;
			tooltip = "Добавляет Артиллерию в КОМЛОГ"; //--- ToDo: Localize;
		};
