...
class MCC_keyBindsGroup: MCC_RscControlsGroup
{
	...
	class controls
	{
		class MCC_keyBindsOpenMCCtext: MCC_RscText
		{
			...
			text = "Открыть MCC:"; //--- ToDo: Localize;
		...
		class MCC_keyBindsOpenT2Ttext: MCC_RscText
		{
			...
			text = "Телепорт к команде:"; //--- ToDo: Localize;
			x = 0.00515597 * safezoneW;
			y = 0.143 * safezoneH;
			w = 0.0973958 * safezoneW;
			h = 0.0219914 * safezoneH;
		...
		class MCC_keyBindsOpenGroupstext: MCC_RscText
		{
			...
			text = "Управление командой:"; //--- ToDo: Localize;
			x = 0.00515597 * safezoneW;
			y = 0.176 * safezoneH;
			w = 0.0973958 * safezoneW;
			h = 0.0219914 * safezoneH;
		...
		class MCC_keyBindsMCCinteractiontext: MCC_RscText
		{
			...
			text = "Взаимодействие:"; //--- ToDo: Localize;
			x = 0.00515597 * safezoneW;
			y = 0.209 * safezoneH;
			w = 0.0973958 * safezoneW;
			h = 0.0219914 * safezoneH;
		...
		class MCC_keyBindsMCCinteractionSelftext: MCC_RscText
		{
			...
			text = "Взаимодействие с собой:"; //--- ToDo: Localize;
			x = 0.00515597 * safezoneW;
			y = 0.242 * safezoneH;
			w = 0.0973958 * safezoneW;
			h = 0.0219914 * safezoneH;
		...
		class MCC_coverSystemClientText: MCC_RscText
		{
			...
			text = "Система Укрытий:"; //--- ToDo: Localize;
			x = 0.00515597 * safezoneW;
			y = 0.275 * safezoneH;
			w = 0.0973958 * safezoneW;
			h = 0.0219914 * safezoneH;
		...
		{
			idc = 8499;
			tooltip = "Нажмите чтобы выключить сторону клиента";
			sizeEx = "(((((safezoneW / safezoneH) min 1.2) / 1.2) / 25) * 0.8)";
			text = "Выключено"; //--- ToDo: Localize;
