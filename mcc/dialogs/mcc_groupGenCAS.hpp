class MCC_CASDialogControls:MCC_RscControlsGroup
{
	...
	class Controls
	{
		...
		class MCC_CASCall: MCC_RscButton
		{
			...
			h = 0.0329871 * safezoneH;
			tooltip = "Вызывает поддержку с воздуха, проведите линию на карте"; //--- ToDo: Localize;
		};
		class MCC_CASAdd: MCC_RscButton
		{
			...
			w = 0.0802083 * safezoneW;
			h = 0.0329871 * safezoneH;
			tooltip = "Добавляет Авиаподдержку в КОМЛОГ"; //--- ToDo: Localize;
		};
