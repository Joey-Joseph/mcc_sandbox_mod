...
class MCC_tasksDialogControls: MCC_RscControlsGroup
{
	...
	class Controls
	{
		...
		class MCC_TasksGeneratorTittle: MCC_RscText
		{
			...
			text = "Генератор Заданий:"; //--- ToDo: Localize;
