class MCC_evacDialogControls:MCC_RscControlsGroup
{
	...
	class Controls
	{
		...
		class MCC_evacSpawn: MCC_RscButton
		{
			...
			h = 0.0219914 * safezoneH;
			tooltip = "Спавн Эвакуационного транспорта на карте"; //--- ToDo: Localize;
			sizeEx = "(((((safezoneW / safezoneH) min 1.2) / 1.2) / 25) * 0.8)";
		};
		...
		class MCC_evacWp: MCC_RscButton
		{
			...
			text = "1 Точка"; //--- ToDo: Localize;
			x = 0.171875 * safezoneW;
			y = 0.197923 * safezoneH;
			w = 0.0458333 * safezoneW;
			h = 0.0329871 * safezoneH;
			tooltip = "Добавить маршрутную точку"; //--- ToDo: Localize;
			sizeEx = "(((((safezoneW / safezoneH) min 1.2) / 1.2) / 25) * 0.8)";
		};
		class MCC_evac3Wp: MCC_RscButton
		{
			...
			text = "3 Точки"; //--- ToDo: Localize;
			x = 0.171875 * safezoneW;
			y = 0.142944 * safezoneH;
			w = 0.0458333 * safezoneW;
			h = 0.0329871 * safezoneH;
			tooltip = "Добавить 3 Маршрутные точки"; //--- ToDo: Localize;
			sizeEx = "(((((safezoneW / safezoneH) min 1.2) / 1.2) / 25) * 0.8)";
		};
		...
		class MCC_evacDelHeli: MCC_RscButton
		{
			...
			text = "Транспорт"; //--- ToDo: Localize;
			x = 0.0572917 * safezoneW;
			y = 0.109957 * safezoneH;
			w = 0.0458333 * safezoneW;
			h = 0.0219914 * safezoneH;
			colorText[] = {1,0,0,0.7};
			tooltip = "Удаляет Транспорт"; //--- ToDo: Localize;
			sizeEx = "(((((safezoneW / safezoneH) min 1.2) / 1.2) / 25) * 0.8)";
		};
		...
		class MCC_evacDelPilot: MCC_RscButton
		{
			...
			text = "Водитель"; //--- ToDo: Localize;
			x = 0.131771 * safezoneW;
			y = 0.109957 * safezoneH;
			w = 0.0458333 * safezoneW;
			h = 0.0219914 * safezoneH;
			colorText[] = {1,0,0,0.7};
			tooltip = "Удаляет водителя"; //--- ToDo: Localize;
			sizeEx = "(((((safezoneW / safezoneH) min 1.2) / 1.2) / 25) * 0.8)";
		};
		class MCC_evacResHeli: MCC_RscButton
		{
			...
			h = 0.0219914 * safezoneH;
			colorText[] = {0,1,0,0.7};
			tooltip = "Оживляет водителя"; //--- ToDo: Localize;
			sizeEx = "(((((safezoneW / safezoneH) min 1.2) / 1.2) / 25) * 0.8)";
		};
