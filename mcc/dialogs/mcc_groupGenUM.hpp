...
class MCC_UMDialogControls:MCC_RscControlsGroup
{
	...
	class Controls
	{
		...
		class MCC_UMJoin: MCC_RscButton
		{
			...
			text = "Присоединить"; //--- ToDo: Localize;
			x = 0.234896 * safezoneW;
			y = 0.0329868 * safezoneH;
			w = 0.0515625 * safezoneW;
			h = 0.0219914 * safezoneH;
		...
		class MCC_UMhint: MCC_RscText
		{
			...
			text = "*Ctrl/Shift чтобы выбрать несколько"; //--- ToDo: Localize;
		...
		{
			idc = -1;
			strings[] = {"Обычное","ПНВ","Тепловизор"};
			rows = 1;
			columns = 3;
			values[] = {0,1,3};
