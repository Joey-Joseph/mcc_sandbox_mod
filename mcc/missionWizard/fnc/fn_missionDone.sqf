...
for "_i" from 1 to _counter do {
	...
	if (_randomAsset > 0.6 && ([["hq",3], _sidePlayer, 200] call MCC_fnc_CheckBuildings)) then {
		...
		_spawnKind = ["Авиаподдержка - (Пушка)","Авиаподдержка - (Ракеты)","Авиаподдержка - (П+Р)","Авиаподдержка - (Бомба)","Найти и уничтожить","Обстрел ракетами","Уничтожить воздух","Умная бомба","Лазерное наведение","Бомбежка"] call bis_fnc_selectRandom;
